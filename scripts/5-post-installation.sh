...
# 5.1.1 pacman keyring initialization
...
# 5.1.2 enable 32-bit packages
sed -i '/^#\[multilib\]/,/^#Include/ {s/^#//; }' /etc/pacman.conf

# 5.1.3 ensure network connectivity
...
# 5.2.3 pulseaudio configuration
...
# 5.2.4 install Arch User Repository helper
